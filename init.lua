...
vim.api.nvim_set_keymap('n', '<CR>', ':w<CR>:vsp<CR>:term python %<CR>i', { noremap = true, silent = false })
...
vim.keymap.set({ 'n', 'i' }, '<D-s>', ':wall<ENTER>')
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        defaults = {
          ...
          file_ignore_patterns = { '%.png$', '%.json', '%.jpg', '%.ttf', '%.svg', '%.mjs' },
        },
        extensions = {
          ['ui-select'] = {
